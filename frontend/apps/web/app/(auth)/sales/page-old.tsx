...
export default function SalesPage() {
  ...
  const getProductPrice = (product: Product, variationId?: string) => {
    ...
    // For now, just use base product price (variations don't have separate pricing in our schema)
    const basePrice = isWholesale ? parseFloat(product.wholesalePrice) : parseFloat(product.retailPrice);
    return basePrice;
  };
  ...
  const addToCart = (product: Product, variationId?: string) => {
    ...
    const availableStock = variation?.stockQuantity ?? product.stockQuantity;
